...
### Overview
In learning  previous chapters of basics and algorithmic theory now time to go with applied side of knowledge goal is complete understand of Python for AI researcher

### Units
| Units | Topics Covered| Assements |
|---|---|---|
| Unit 2.0 | DS Essential:Working with Data, Process flow, Mastering Numpy and Pandas|Load and Summarize data|
|Unit 2.1| Data Cleaning: Quality, handling missing duplicates outliers, string and data & time operations, combine and merging datasets| clean titanic dataset, clean other imbalance dataset|
